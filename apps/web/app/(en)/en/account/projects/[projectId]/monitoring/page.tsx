...
export default async function MonitoringPage({ params }: { params: Promise<{ projectId: string }> }) {
  ...
  return <AccountWorkspaceShell locale="en" section="monitoring" currentProjectId={projectId}><AccountMonitoring locale="en" projectId={projectId} /></AccountWorkspaceShell>;
}
