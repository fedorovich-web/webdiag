...
expect(api.WEBDIAG_CRAWLER_ACTIVE_JOB_LIMIT_PER_USER === "2", "crawler user limit differs");
expect(api.WEBDIAG_CRAWLER_ACTIVE_JOB_LIMIT_GLOBAL === "25", "crawler queue limit differs");
expect(
